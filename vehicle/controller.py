...
class MDPVehicle(ControlledVehicle):
    ...
    def act(self, action: Union[dict, str] = None) -> None:
        ...
        # if action and self.speed + float(action) >= 0:
        #     self.target_speed = self.speed + float(action)
        #     self.acceleration = float(action)
        # else:
        #     self.target_speed = self.speed + self.acceleration
